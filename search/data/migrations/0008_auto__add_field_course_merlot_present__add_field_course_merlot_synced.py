...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.merlot_present'
        db.add_column(u'data_course', 'merlot_present', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Course.merlot_synced'
        db.add_column(u'data_course', 'merlot_synced', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.merlot_present'
        db.delete_column(u'data_course', 'merlot_present')

        # Deleting field 'Course.merlot_synced'
        db.delete_column(u'data_course', 'merlot_synced')
