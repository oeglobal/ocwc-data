...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Source.edit_key'
        db.add_column(u'data_source', 'edit_key', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Source.edit_key'
        db.delete_column(u'data_source', 'edit_key')
