...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.merlot_synced_date'
        db.add_column(u'data_course', 'merlot_synced_date', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Course.merlot_id'
        db.add_column(u'data_course', 'merlot_id', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.merlot_synced_date'
        db.delete_column(u'data_course', 'merlot_synced_date')

        # Deleting field 'Course.merlot_id'
        db.delete_column(u'data_course', 'merlot_id')
