...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.is_404'
        db.add_column(u'data_course', 'is_404', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.is_404'
        db.delete_column(u'data_course', 'is_404')
