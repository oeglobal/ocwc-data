...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.content_medium'
        db.add_column(u'data_course', 'content_medium', self.gf('django.db.models.fields.CharField')(default='text', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.content_medium'
        db.delete_column(u'data_course', 'content_medium')
