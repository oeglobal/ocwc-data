...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MerlotCategory.parent'
        db.add_column(u'data_merlotcategory', 'parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['data.MerlotCategory']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MerlotCategory.parent'
        db.delete_column(u'data_merlotcategory', 'parent_id')
