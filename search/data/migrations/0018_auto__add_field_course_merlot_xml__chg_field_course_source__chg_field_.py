...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.merlot_xml'
        db.add_column(u'data_course', 'merlot_xml', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Changing field 'Course.source'
        db.alter_column(u'data_course', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Source'], null=True))

        # Changing field 'Course.provider'
        db.alter_column(u'data_course', 'provider_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Provider'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'Course.merlot_xml'
        db.delete_column(u'data_course', 'merlot_xml')

        # User chose to not deal with backwards NULL issues for 'Course.source'
        raise RuntimeError("Cannot reverse this migration. 'Course.source' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Course.provider'
        raise RuntimeError("Cannot reverse this migration. 'Course.provider' and its values cannot be restored.")
    ...
    models = {
        ...
        u'data.course': {
            ...
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['data.Provider']", 'null': 'True'}),
            'rights': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['data.Source']", 'null': 'True'}),
