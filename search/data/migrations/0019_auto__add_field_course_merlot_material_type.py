...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.merlot_material_type'
        db.add_column(u'data_course', 'merlot_material_type', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.merlot_material_type'
        db.delete_column(u'data_course', 'merlot_material_type')
    ...
    models = {
        ...
        u'data.course': {
            ...
            'merlot_material_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
