...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.creative_commons'
        db.add_column(u'data_course', 'creative_commons', self.gf('django.db.models.fields.CharField')(default='Unsure', max_length=30), keep_default=False)

        # Adding field 'Course.creative_commons_commercial'
        db.add_column(u'data_course', 'creative_commons_commercial', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'Course.creative_commons_derivatives'
        db.add_column(u'data_course', 'creative_commons_derivatives', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.creative_commons'
        db.delete_column(u'data_course', 'creative_commons')

        # Deleting field 'Course.creative_commons_commercial'
        db.delete_column(u'data_course', 'creative_commons_commercial')

        # Deleting field 'Course.creative_commons_derivatives'
        db.delete_column(u'data_course', 'creative_commons_derivatives')
