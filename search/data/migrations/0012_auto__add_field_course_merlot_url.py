...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.merlot_url'
        db.add_column(u'data_course', 'merlot_url', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.merlot_url'
        db.delete_column(u'data_course', 'merlot_url')
