...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field merlot_languages on 'Course'
        db.create_table(u'data_course_merlot_languages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm[u'data.course'], null=False)),
            ('merlotlanguage', models.ForeignKey(orm[u'data.merlotlanguage'], null=False))
        ))
        db.create_unique(u'data_course_merlot_languages', ['course_id', 'merlotlanguage_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field merlot_languages on 'Course'
        db.delete_table('data_course_merlot_languages')
    ...
    models = {
        ...
        u'data.course': {
            ...
            'merlot_languages': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['data.MerlotLanguage']", 'null': 'True', 'symmetrical': 'False'}),
