...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.author_organization'
        db.add_column(u'data_course', 'author_organization', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.author_organization'
        db.delete_column(u'data_course', 'author_organization')
