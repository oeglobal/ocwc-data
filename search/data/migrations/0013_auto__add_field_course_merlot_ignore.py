...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.merlot_ignore'
        db.add_column(u'data_course', 'merlot_ignore', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.merlot_ignore'
        db.delete_column(u'data_course', 'merlot_ignore')
