...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'data_course', 'image_url', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Course.audience'
        db.add_column(u'data_course', 'audience', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.image_url'
        db.delete_column(u'data_course', 'image_url')

        # Deleting field 'Course.audience'
        db.delete_column(u'data_course', 'audience')
